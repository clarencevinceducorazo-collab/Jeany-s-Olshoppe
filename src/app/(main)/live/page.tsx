...
import { Play, Navigation2, Calendar, Clock } from 'lucide-react';
...
export default function LivePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="relative w-full aspect-video md:aspect-[21/9] max-h-[70vh] bg-black overflow-hidden flex items-center justify-center">
        ...
        <FadeIn delay={0.2} className="relative z-10 flex flex-col items-center text-center px-4">
          ...
          <p className="text-white/80 max-w-md mx-auto text-sm md:text-base font-medium">
            Join our daily live sessions to discover exclusive Japan Surplus items, bid in real-time, and chat directly with us!
          </p>
          <div className="mt-6 inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/10">
             ...
             <span className="text-white text-sm font-semibold tracking-wide">Live today from 11:00 AM - 4:00 PM</span>
          </div>
        </FadeIn>
      </section>

      {/* Schedule Section */}
      <section className="py-16 md:py-24 bg-background container mx-auto px-4 max-w-5xl">
        <FadeIn direction="up">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <h2 className="text-2xl font-semibold tracking-tight text-primary">Weekly Broadcast Schedule</h2>
              <p className="text-muted-foreground text-sm font-medium">Plan your week around our drops.</p>
            </div>
          </div>
